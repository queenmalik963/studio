  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        'glow-blue': {
            '0%, 100%': { filter: 'drop-shadow(0 0 5px rgba(59, 130, 246, 0.6))' },
        ...
        'glow-cyan': {
            '0%, 100%': { filter: 'drop-shadow(0 0 5px rgba(6, 182, 212, 0.6))' },
            '50%': { filter: 'drop-shadow(0 0 10px rgba(6, 182, 212, 1))' },
        },
        'glow-pink': {
            '0%, 100%': { filter: 'drop-shadow(0 0 5px rgba(219, 39, 119, 0.6))' },
            '50%': { filter: 'drop-shadow(0 0 10px rgba(219, 39, 119, 1))' },
        },
        'glow-teal': {
            '0%, 100%': { filter: 'drop-shadow(0 0 5px rgba(20, 184, 166, 0.6))' },
            '50%': { filter: 'drop-shadow(0 0 10px rgba(20, 184, 166, 1))' },
        },
        'glow-orange': {
            '0%, 100%': { filter: 'drop-shadow(0 0 5px rgba(249, 115, 22, 0.6))' },
            '50%': { filter: 'drop-shadow(0 0 10px rgba(249, 115, 22, 1))' },
        },
        'glow-indigo': {
            '0%, 100%': { filter: 'drop-shadow(0 0 5px rgba(99, 102, 241, 0.6))' },
            '50%': { filter: 'drop-shadow(0 0 10px rgba(99, 102, 241, 1))' },
        },
        'glow-lime': {
            '0%, 100%': { filter: 'drop-shadow(0 0 5px rgba(132, 204, 22, 0.6))' },
            '50%': { filter: 'drop-shadow(0 0 10px rgba(132, 204, 22, 1))' },
        },
        'glow-rose': {
            '0%, 100%': { filter: 'drop-shadow(0 0 5px rgba(244, 63, 94, 0.6))' },
