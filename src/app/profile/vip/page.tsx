...
const vipTiers = [
  ...
  { name: "Master", price: "$79.99/mo", features: ["Master Badge", "All Diamond Perks", "Beta Access"], color: "from-purple-500 to-purple-700", frameClass: "border-purple-400 animate-glow-purple", frameSvg: (props: any) => (<svg {...props} viewBox="0 0 100 100"><path d="M50,2.5A47.5,47.5,0,1,1,2.5,50,47.5,47.5,0,0,1,50,2.5" fill="none" stroke="#a020f0" strokeWidth="5"/><path d="M25,25 L75,75 M25,75 L75,25" stroke="#a020f0" strokeWidth="5"/></svg>) },
